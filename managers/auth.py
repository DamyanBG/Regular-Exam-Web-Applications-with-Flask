...
mapper = {
    CustomerModel: lambda: CustomerModel.query.filter_by(pk=x),
    AdministratorModel: lambda: CustomerModel.query.filter_by(pk=x),
    WorkerModel: lambda: CustomerModel.query.filter_by(pk=x),
}
