...
class S3Service:
    ...
    def upload_stl(self, file_name, object_name):
        try:
            ext = file_name.split(".")[-1]
            self.s3.upload_file(file_name, self.bucket_name, object_name, ExtraArgs={'ACL': 'public-read', 'ContentType': f'standard_triangle_file/{ext}'})
